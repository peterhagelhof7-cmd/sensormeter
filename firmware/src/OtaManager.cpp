...
// den 10s-Task-Watchdog (Panic bei Timeout) NUR fuer den Haupt-Loop-Task
...
// hat.
//
// 2026-07-18 korrigiert: die vorherige Fassung kopierte jeden Chunk in
// einen auf kTailCap+512 Byte GEDECKELTEN Zwischenpuffer und durchsuchte
// nur diesen - bei einem echten HTTP-Upload liefert AsyncWebServer aber
// regelmaessig groessere Chunks als 512 Byte, wodurch alles jenseits der
// Deckelung STILLSCHWEIGEND uebersprungen wurde (weder gescannt noch als
// Tail vorgemerkt). Erster echter End-to-End-OTA-Test auf realer Hardware
// (siehe docs/entscheidungen.md) hat genau das aufgedeckt: der Marker war
// nachweislich in der .bin vorhanden, wurde aber trotzdem nicht gefunden.
// Fix: kein kopierter Zwischenpuffer mehr fuer den Chunk selbst - findBytes()
...
// reichen kTailCap+kMarkerPrefixLen Byte, unabhaengig von der tatsaechlichen
// Chunkgroesse.

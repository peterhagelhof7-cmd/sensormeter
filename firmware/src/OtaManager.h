...
// GitHub-Versionscheck/-Direktinstall wurde entfernt, um den HTTPS-Client
// (WiFiClientSecure/HTTPClient) und dessen mbedTLS-Flash-Bedarf zu sparen -
// das Flash-Budget war nach P5 sehr eng, siehe dortige Begruendung).
//

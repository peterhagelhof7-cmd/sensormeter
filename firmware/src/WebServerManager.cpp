...
String WebServerManager::buildPageShell(const String& title, const String& bodyContent) const {
  ...
  // Umfang) werden auf die Breite des umgebenden Labels (max-width:420px
  // weiter unten) gedeckelt statt darueber hinauszulaufen - Browser kuerzt
  // die Anzeige des gewaehlten Werts dann automatisch mit Ellipsis.

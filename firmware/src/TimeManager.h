...
// zuerst explizit ueber LAN unternommen (NetworkManager::pinDefaultInterface,
...
// laeuft (siehe sensormeter-Log-Analyse 2026-07-22).
//
...
class TimeManager {
 ...
 private:
  ...
  // wiederherstellen kann - siehe NetworkManager::pinDefaultInterface().
